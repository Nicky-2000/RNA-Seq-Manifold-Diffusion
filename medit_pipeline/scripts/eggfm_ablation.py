...
def main() -> None:
    ...
    # diffusion-time and neighborhood grids
                    ...
                    for t_val in t_grid:
                        for k_neighbors in n_neighbors_grid:
                            for num_epochs in epochs_grid:
                                ...
                                cfg["eggfm_train"]["num_epochs"] = int(num_epochs)
                                ...
                                # qc_run.obsm["X_eggfm"] should now be the pure EGGFM DM
                                # built with t = t_val and n_neighbors = k_neighbors.
                                ...
                                qc_run.obsm["X_diff_eggfm_x2"] = qc_run.obsm[
                                    "X_diffmap"
                                ][:, :n_pcs]
                                ...
                                try:
                                    ...
                                    print(
                                        f"[main] ARI failed for X_eggfm: {e}",
                                        flush=True,
                                    )
                                    ari_eggfm = float("nan")
                                ...
                                with out_txt_path.open("a") as f:
                                    f.write(
                                        ...
                                        f"{eps_trunc}\t{t_val}\t{k_neighbors}\t{num_epochs}\t"
